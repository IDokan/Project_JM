...
// File: MageStateVisual.cs
// Summary: Mage-specific visual responses — beak changes on victory; eye and beak change on damaged.
// Unauthorized copying, distribution, or modification of this file is strictly prohibited.

using UnityEngine;
using UnityEngine.U2D.Animation;

public class MageStateVisual : CharacterStateVisual
{
